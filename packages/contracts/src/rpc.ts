...
const WsProviderExecutionGoalGetRpc = Rpc.make(WS_METHODS.providerExecutionGoalGet, {
...
const WsProviderExecutionGoalPauseRpc = Rpc.make(WS_METHODS.providerExecutionGoalPause, {
  payload: ProviderExecutionGoalInput,
  success: Schema.Struct({}),
  error: Schema.Union([ProviderExecutionGoalError, EnvironmentAuthorizationError]),
});

const WsProviderExecutionGoalClearRpc = Rpc.make(WS_METHODS.providerExecutionGoalClear, {
  payload: ProviderExecutionGoalInput,
  success: Schema.Struct({}),
  error: Schema.Union([ProviderExecutionGoalError, EnvironmentAuthorizationError]),
});
...
const WsOrchestrationSubagentControlStatusRpc = Rpc.make(
...
const WsOrchestrationSubagentControlSteerRpc = Rpc.make(
...
const WsOrchestrationSubagentControlCancelRpc = Rpc.make(
