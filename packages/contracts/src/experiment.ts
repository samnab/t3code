...
export const THREAD_EXPERIMENT_MAX_APPROVED_FILES = 256;
export const THREAD_EXPERIMENT_MAX_CHECKS = 32;
export const THREAD_EXPERIMENT_MAX_ARGV_ITEMS = 64;
export const THREAD_EXPERIMENT_MAX_ARG_CHARS = 4_096;
export const THREAD_EXPERIMENT_MAX_EXPERIMENTS = 1_000;
export const THREAD_EXPERIMENT_MAX_TOTAL_SECONDS = 604_800;
export const THREAD_EXPERIMENT_MAX_COMMAND_SECONDS = 3_600;
export const THREAD_EXPERIMENT_MAX_OUTPUT_BYTES = 16_777_216;
export const THREAD_EXPERIMENT_MAX_BYTES_PER_FILE = 4_194_304;
export const THREAD_EXPERIMENT_MAX_TOTAL_APPLY_BYTES = 16_777_216;
...
const ApplyFiles = PositiveInt.check(
  Schema.isLessThanOrEqualTo(THREAD_EXPERIMENT_MAX_APPROVED_FILES),
);
