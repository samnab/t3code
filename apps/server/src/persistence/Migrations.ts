...
import Migration0046 from "./Migrations/046_ProjectionSubagentRuns.ts";
import Migration0047 from "./Migrations/047_ProjectionThreadGoal.ts";
import Migration0048 from "./Migrations/048_ProjectionSubagentTranscripts.ts";
import Migration0049 from "./Migrations/049_ProjectionThreadsVoiceNotifications.ts";
import Migration0050 from "./Migrations/050_ProjectionThreadGoalLoop.ts";
import Migration0051 from "./Migrations/051_NativeChildRuns.ts";
import Migration0052 from "./Migrations/052_ProjectionThreadMessagesOrigin.ts";
import Migration0053 from "./Migrations/053_RepairAutomaticSettlementTimestamps.ts";
import Migration0054 from "./Migrations/054_ProjectionProjectIcon.ts";
import Migration0055 from "./Migrations/055_ProjectionThreadBranchPullRequest.ts";
import Migration0056 from "./Migrations/056_ProjectionThreadsActiveOrderKey.ts";
import Migration0057 from "./Migrations/057_ThreadExperiments.ts";
...
import Migration0064 from "./Migrations/064_ProjectionProjectsSchedules.ts";
...
const migrationEntries = [
  ...
  [46, "ProjectionSubagentRuns", Migration0046],
  [47, "ProjectionThreadGoal", Migration0047],
  [48, "ProjectionSubagentTranscripts", Migration0048],
  [49, "ProjectionThreadsVoiceNotifications", Migration0049],
  [50, "ProjectionThreadGoalLoop", Migration0050],
  [51, "NativeChildRuns", Migration0051],
  [52, "ProjectionThreadMessagesOrigin", Migration0052],
  ...
  [57, "ThreadExperiments", Migration0057],
  ...
  [64, "ProjectionProjectsSchedules", Migration0064],
